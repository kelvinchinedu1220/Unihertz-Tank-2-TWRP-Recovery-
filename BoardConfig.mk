...
DEVICE_PATH := device/oblue/TANK2
...
# Assert
TARGET_OTA_ASSERT_DEVICE := TANK2

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := G88BoardV1
...
TARGET_KERNEL_CONFIG := TANK2_defconfig
TARGET_KERNEL_SOURCE := kernel/oblue/TANK2
